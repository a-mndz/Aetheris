...
class TestCRIT007LiveKeyRejection:
    def test_live_openrouter_key_rejected_via_validator(self) -> None:
    ...
    def test_live_nvidia_key_rejected(self) -> None:
        from pydantic import ValidationError
...
class TestCRIT005JWTSecretHardening:
    ...
    def test_strong_secret_accepted(self) -> None:
        ...
        try:
            ...
            os.environ["AETHERIS_JWT_SECRET_KEY"] = os.environ.get("AETHERIS_JWT_SECRET_KEY", "test-only-do-not-use-in-production-32chars-min")
